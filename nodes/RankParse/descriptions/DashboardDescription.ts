    ...
    options: [
      {
        ...
        value: "me",
        description:
          "Get the account profile and credit balance for this API key (0 credits)",
      ...
      },
      {
        ...
        value: "credits",
        description:
          "Check the current credit balance for this API key (0 credits)",
      ...
      },
      {
        ...
        value: "pricing",
        description:
          "Get current credit pack pricing tiers - public, no auth required (0 credits)",
        action: "Get credit pricing",
        routing: {
          request: { method: "GET", url: "/v1/pricing" },
          output: {
            postReceive: [
              { type: "rootProperty", properties: { property: "tiers" } },
            ],
          },
        },
      },
      {
        ...
        value: "usage",
        description:
          "Get paginated usage log entries for this account (0 credits)",
        action: "Get usage log",
        routing: {
          request: { method: "GET", url: "/v1/usage" },
          output: {
            postReceive: [
              { type: "rootProperty", properties: { property: "usage" } },
            ],
          },
        },
      },
      {
        ...
        routing: {
          request: { method: "GET", url: "/v1/keys" },
          output: {
            postReceive: [
              { type: "rootProperty", properties: { property: "keys" } },
            ],
          },
        },
      },
