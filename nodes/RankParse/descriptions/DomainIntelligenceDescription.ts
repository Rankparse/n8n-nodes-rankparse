    ...
    options: [
      {
        ...
        value: "competitorGap",
        description:
          "Find domains linking to a competitor but not to the target (5 credits)",
        action: "Find competitor link gaps",
        routing: {
          request: { method: "GET", url: "/v1/competitor-gap" },
          output: {
            postReceive: [
      ...
      },
      {
        ...
        description:
          "Get a 0-100 authority score enriched with RDAP + Tranco data (1 credit)",
        action: "Get domain authority score",
        routing: {
          request: { method: "GET", url: "/v1/domain-authority" },
          output: {
            postReceive: [
              { type: "rootProperty", properties: { property: "data" } },
            ],
      ...
      },
      {
        ...
        value: "domainOverlap",
        description:
          "Find domains that link to 2-5 target domains at once (5 credits)",
        action: "Find domains linking to multiple targets",
        routing: {
          request: { method: "GET", url: "/v1/domain-overlap" },
          output: {
            postReceive: [
              { type: "rootProperty", properties: { property: "data" } },
            ],
      ...
      },
      {
        ...
        value: "domainRank",
        description:
          "Get inbound edge count and unique linking domain metrics (2 credits)",
        action: "Get domain rank metrics",
        routing: {
          request: { method: "GET", url: "/v1/domain-rank" },
          output: {
            postReceive: [
              { type: "rootProperty", properties: { property: "data" } },
            ],
      ...
      },
      {
        ...
        value: "linkAudit",
        description:
          "Composite backlink quality score, risk flags, and anchor profile in one call (8 credits)",
      ...
      },
      {
        ...
        description:
          "Find domains that share linking domains with the target (5 credits)",
        action: "Find similar domains",
        routing: {
          request: { method: "GET", url: "/v1/similar-domains" },
          output: {
            postReceive: [
              { type: "rootProperty", properties: { property: "data" } },
            ],
      ...
      },
      {
        ...
        value: "siteExplorer",
        description:
          "Backlinks, authority, top pages, and anchor text in one call (10 credits)",
        action: "Get a full site overview",
        routing: {
          request: { method: "GET", url: "/v1/site-explorer" },
          output: {
            postReceive: [
              { type: "rootProperty", properties: { property: "data" } },
            ],
...
export const domainIntelligenceFields: INodeProperties[] = [
  ...
  limitField(RESOURCE, ["competitorGap"], { default: 50, maxValue: 200 }),
  {
    ...
    displayOptions: {
      show: { resource: [RESOURCE], operation: ["domainOverlap"] },
    },
  ...
  },
  {
    ...
    displayOptions: {
      show: { resource: [RESOURCE], operation: ["competitorGap"] },
    },
